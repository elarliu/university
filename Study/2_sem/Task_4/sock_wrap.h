...
{ 
    ...
    public:
        ...
        {
            ESE_SUCCESS, ESE_SOCKCREATE, ESE_SOCKCONN, 
            ESE_SOCKILLEGAL, ESE_SOCKHOSTNAME, ESE_SOCKSEND, 
            ESE_SOCKRECV, ESE_SOCKBIND, ESE_SOCKLISTEN, ESE_SOCKACCEPT,
        };
...
}; // конец namespace ModelSQL #endif
#endif